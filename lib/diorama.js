  ...
  Backbone.Diorama.NestingView = (function(_super) {
    ...
    NestingView.prototype.renderSubViews = function() {
      ...
      if (this.dontShowRenderViewChangeMessage == null) {
        error = new Error("Diorama.NestingView.renderSubViews was called before attachSubViews! If  you've just upgraded diorama, check out the changes to NestingView here:   http://gjigrhgdjhgdkj/");
        error.stack;
        throw error;
      }
      _ref = this.subViews;
