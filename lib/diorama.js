...
(function() {
  ...
  Backbone.Diorama.NestingView = (function(_super) {
    ...
    NestingView.prototype.renderSubViews = function() {
      throw new Error("Diorama.NestingView.renderSubViews is deprecated,      please use attachSubViews and call render in subView's initialize (or manually) instead");
    };
