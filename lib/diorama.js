...
(function() {
  ...
  Backbone.Diorama.NestingView = (function(_super) {
    ...
    function NestingView() {
      this.registerHandlebars = __bind(this.registerHandlebars, this);
      this.viewHelper = __bind(this.viewHelper, this);      _ref = NestingView.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    NestingView.prototype.initialize = function() {
      return this.registerHandlebars(Handlebars);
    };
    ...
    NestingView.prototype.viewHelper = function(context, options) {
      var View, html, view, viewName, viewOptions;
      ...
      html = this.renderSubViews();
      return new Handlebars.SafeString(html);
    };

    NestingView.prototype.registerHandlebars = function(Handlebars) {
      return Handlebars.registerHelper('view', this.viewHelper);
    };
