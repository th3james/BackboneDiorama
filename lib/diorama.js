  ...
  Backbone.Diorama.NestingView = (function(_super) {
    ...
    NestingView.prototype.attachSubViews = function() {
      ...
      if (this.subViews != null) {
        ...
        for (key in _ref) {
          subView = _ref[key];
          _results.push(subView.setElement(this.$el.find("[data-sub-view-key=\"" + key + "\"]")));
        }
        return _results;
      }
    };
    ...
    NestingView.prototype.renderSubViews = function() {
      ...
      if (this.dontShowRenderViewChangeMessage == null) {
        error = new Error("Diorama.NestingView.renderSubViews was called before attachSubViews! If  you've just upgraded diorama, check out the changes to NestingView here:   https://github.com/th3james/BackboneDiorama/blob/master/src/lib/diorama_nesting_view.md#upgrading-from-diorama-012");
        error.stack;
        throw error;
      }
      _ref = this.subViews;
