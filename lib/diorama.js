...
(function() {
  ...
  _.extend(Backbone.View.prototype, {
    close: function() {
      if ((this.onClose != null) && !this._functionIsBoundToEvent(this.onClose, 'close')) {
        throw new Error("onClose is no longer called automatically, please listenTo the view's 'close' event");
      }
      this.trigger('close');
      this.unbind();
      return this.remove();
    },
    _functionIsBoundToEvent: function(func, eventName) {
      var binding, _i, _len, _ref;
      if (this._events != null) {
        _ref = this._events[eventName];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          binding = _ref[_i];
          if (binding.callback === func) {
            return true;
          }
        }
        return false;
